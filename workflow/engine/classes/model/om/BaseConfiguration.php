...
abstract class BaseConfiguration extends BaseObject  implements Persistent
{
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->cfg_uid = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			$this->obj_uid = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->cfg_value = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			return $startcol + 6; // 6 = ConfigurationPeer::NUM_HYDRATE_COLUMNS.
	...
	{
		if (isset($alreadyDumpedObjects['Configuration'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Configuration'][serialize($this->getPrimaryKey())] = true;
	...
	{
		return (null === $this->getCfgUid()) && (null === $this->getObjUid()) && (null === $this->getProUid()) && (null === $this->getUsrUid()) && (null === $this->getAppUid());
	}
	...
	{
		$copyObj->setCfgUid($this->getCfgUid());
		$copyObj->setObjUid($this->getObjUid());
		$copyObj->setCfgValue($this->getCfgValue());
