...
abstract class BaseGateway extends BaseObject  implements Persistent
{
	...
	/**
	 * Initializes internal state of BaseGateway object.
	 * @see        applyDefaults()
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->gat_uid = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			$this->pro_uid = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->tas_uid = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->gat_next_task = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->gat_x = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->gat_y = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->gat_type = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->resetModified();
			...
			return $startcol + 7; // 7 = GatewayPeer::NUM_HYDRATE_COLUMNS.
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		$copyObj->setGatNextTask($this->getGatNextTask());
		$copyObj->setGatX($this->getGatX());
		$copyObj->setGatY($this->getGatY());
		$copyObj->setGatType($this->getGatType());
		if ($makeNew) {
			$copyObj->setNew(true);
		}
	}
