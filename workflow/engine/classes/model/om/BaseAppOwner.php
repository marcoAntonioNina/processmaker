...
abstract class BaseAppOwner extends BaseObject  implements Persistent
{
	...
	/**
	 * Initializes internal state of BaseAppOwner object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     AppOwner The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->own_uid = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			...
			return $startcol + 3; // 3 = AppOwnerPeer::NUM_HYDRATE_COLUMNS.
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AppOwnerPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = AppOwnerQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				AppOwnerPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	{
		if (isset($alreadyDumpedObjects['AppOwner'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['AppOwner'][serialize($this->getPrimaryKey())] = true;
	...
	{
		return (null === $this->getAppUid()) && (null === $this->getOwnUid()) && (null === $this->getUsrUid());
	}
	...
	{
		return (string) $this->exportTo(AppOwnerPeer::DEFAULT_STRING_FORMAT);
	}
