...
abstract class BaseDimTimeComplete extends BaseObject  implements Persistent
{
	 ...
	 * Peer class name
	 */
	const PEER = 'DimTimeCompletePeer';
	...
	/**
	 * Initializes internal state of BaseDimTimeComplete object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     DimTimeComplete The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 8; // 8 = DimTimeCompletePeer::NUM_HYDRATE_COLUMNS.
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = DimTimeCompletePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = DimTimeCompleteQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				DimTimeCompletePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	{
		if (isset($alreadyDumpedObjects['DimTimeComplete'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['DimTimeComplete'][$this->getPrimaryKey()] = true;
	...
	{
		return (string) $this->exportTo(DimTimeCompletePeer::DEFAULT_STRING_FORMAT);
	}
