...
abstract class BaseStage extends BaseObject  implements Persistent
{
	...
	/**
	 * Initializes internal state of BaseStage object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Stage The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->stg_uid = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			$this->pro_uid = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->stg_posx = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->stg_posy = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->stg_index = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->resetModified();
			...
			return $startcol + 5; // 5 = StagePeer::NUM_HYDRATE_COLUMNS.
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = StagePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				StagePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	{
		if (isset($alreadyDumpedObjects['Stage'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Stage'][$this->getPrimaryKey()] = true;
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		$copyObj->setStgPosx($this->getStgPosx());
		$copyObj->setStgPosy($this->getStgPosy());
		$copyObj->setStgIndex($this->getStgIndex());
		if ($makeNew) {
			$copyObj->setNew(true);
		}
	}
	...
	{
		return (string) $this->exportTo(StagePeer::DEFAULT_STRING_FORMAT);
	}
