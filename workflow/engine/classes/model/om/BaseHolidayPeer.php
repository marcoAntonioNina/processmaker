...
require_once 'classes/model/map/HolidayTableMap.php';
...
abstract class BaseHolidayPeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_STUDLYPHPNAME => array ('hldUid', 'hldDate', 'hldDescription', ),
        BasePeer::TYPE_COLNAME => array (self::HLD_UID, self::HLD_DATE, self::HLD_DESCRIPTION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('HLD_UID', 'HLD_DATE', 'HLD_DESCRIPTION', ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_STUDLYPHPNAME => array ('hldUid' => 0, 'hldDate' => 1, 'hldDescription' => 2, ),
        BasePeer::TYPE_COLNAME => array (self::HLD_UID => 0, self::HLD_DATE => 1, self::HLD_DESCRIPTION => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('HLD_UID' => 0, 'HLD_DATE' => 1, 'HLD_DESCRIPTION' => 2, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn($alias . '.HLD_UID');
            $criteria->addSelectColumn($alias . '.HLD_DATE');
            $criteria->addSelectColumn($alias . '.HLD_DESCRIPTION');
        }
    }
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        $cls = HolidayPeer::getOMClass(false);
    ...
    {
        return $withPrefix ? HolidayPeer::CLASS_DEFAULT : HolidayPeer::OM_CLASS;
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(HolidayPeer::HLD_UID) && $criteria->keyContainsValue(HolidayPeer::HLD_UID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.HolidayPeer::HLD_UID.')');
        }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $value = $criteria->remove(HolidayPeer::HLD_UID);
            if ($value) {
                $selectCriteria->add(HolidayPeer::HLD_UID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(HolidayPeer::TABLE_NAME);
            }

        } else {
            // $values is Holiday object
