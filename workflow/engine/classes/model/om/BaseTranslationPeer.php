...
require_once 'classes/model/map/TranslationTableMap.php';
...
abstract class BaseTranslationPeer
{
    ...
    /**
     * An identiy map to hold any loaded instances of Translation objects.
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_STUDLYPHPNAME => array ('trnCategory', 'trnId', 'trnLang', 'trnValue', 'trnUpdateDate', ),
        BasePeer::TYPE_COLNAME => array (self::TRN_CATEGORY, self::TRN_ID, self::TRN_LANG, self::TRN_VALUE, self::TRN_UPDATE_DATE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('TRN_CATEGORY', 'TRN_ID', 'TRN_LANG', 'TRN_VALUE', 'TRN_UPDATE_DATE', ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_STUDLYPHPNAME => array ('trnCategory' => 0, 'trnId' => 1, 'trnLang' => 2, 'trnValue' => 3, 'trnUpdateDate' => 4, ),
        BasePeer::TYPE_COLNAME => array (self::TRN_CATEGORY => 0, self::TRN_ID => 1, self::TRN_LANG => 2, self::TRN_VALUE => 3, self::TRN_UPDATE_DATE => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('TRN_CATEGORY' => 0, 'TRN_ID' => 1, 'TRN_LANG' => 2, 'TRN_VALUE' => 3, 'TRN_UPDATE_DATE' => 4, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn($alias . '.TRN_CATEGORY');
            $criteria->addSelectColumn($alias . '.TRN_ID');
            $criteria->addSelectColumn($alias . '.TRN_LANG');
            $criteria->addSelectColumn($alias . '.TRN_VALUE');
            $criteria->addSelectColumn($alias . '.TRN_UPDATE_DATE');
        }
    }
     ...
     *
     * @param      Translation $value A Translation object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if ($key === null) {
                $key = serialize(array((string) $obj->getTrnCategory(), (string) $obj->getTrnId(), (string) $obj->getTrnLang()));
            } // if key === null
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof Translation) {
                $key = serialize(array((string) $value->getTrnCategory(), (string) $value->getTrnId(), (string) $value->getTrnLang()));
    ...
    /**
     * Method to invalidate the instance pool of all tables related to TRANSLATION
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        $cls = TranslationPeer::getOMClass(false);
    ...
    {
        return $withPrefix ? TranslationPeer::CLASS_DEFAULT : TranslationPeer::OM_CLASS;
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $value = $criteria->remove(TranslationPeer::TRN_CATEGORY);
            if ($value) {
                $selectCriteria->add(TranslationPeer::TRN_CATEGORY, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(TranslationPeer::TABLE_NAME);
            }

            $comparison = $criteria->getComparison(TranslationPeer::TRN_ID);
            $value = $criteria->remove(TranslationPeer::TRN_ID);
            if ($value) {
                $selectCriteria->add(TranslationPeer::TRN_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(TranslationPeer::TABLE_NAME);
            }

            $comparison = $criteria->getComparison(TranslationPeer::TRN_LANG);
            $value = $criteria->remove(TranslationPeer::TRN_LANG);
            if ($value) {
                $selectCriteria->add(TranslationPeer::TRN_LANG, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(TranslationPeer::TABLE_NAME);
            }

        } else {
            // $values is Translation object
    ...
    public static function doDelete($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(TranslationPeer::TRN_CATEGORY, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(TranslationPeer::TRN_ID, $value[1]));
                $criterion->addAnd($criteria->getNewCriterion(TranslationPeer::TRN_LANG, $value[2]));
     ...
     * @return     Translation
     */
    public static function retrieveByPK($trn_category, $trn_id, $trn_lang, PropelPDO $con = null) {
        $_instancePoolKey = serialize(array((string) $trn_category, (string) $trn_id, (string) $trn_lang));
