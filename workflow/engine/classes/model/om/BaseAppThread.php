...
abstract class BaseAppThread extends BaseObject  implements Persistent
{
	...
	public function applyDefaultValues()
	{
		...
		$this->app_thread_parent = 0;
		$this->app_thread_status = 'OPEN';
		$this->del_index = 0;
	}

	/**
	 * Initializes internal state of BaseAppThread object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     AppThread The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->app_thread_index = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->app_thread_parent = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->app_thread_status = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->del_index = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->resetModified();
			...
			return $startcol + 5; // 5 = AppThreadPeer::NUM_HYDRATE_COLUMNS.
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AppThreadPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = AppThreadQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				AppThreadPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	{
		if (isset($alreadyDumpedObjects['AppThread'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['AppThread'][serialize($this->getPrimaryKey())] = true;
	...
	{
		return (null === $this->getAppUid()) && (null === $this->getAppThreadIndex());
	}
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		$copyObj->setAppThreadParent($this->getAppThreadParent());
	...
	{
		return (string) $this->exportTo(AppThreadPeer::DEFAULT_STRING_FORMAT);
	}
