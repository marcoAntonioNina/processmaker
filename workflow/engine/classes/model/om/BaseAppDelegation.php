...
abstract class BaseAppDelegation extends BaseObject  implements Persistent
{
	...
	public function applyDefaultValues()
	{
		...
		$this->del_finished = 0;
		$this->del_delayed = 0;
		$this->app_overdue_percentage = 0;
	}

	/**
	 * Initializes internal state of BaseAppDelegation object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     AppDelegation The current object (for fluent API support)
	 */
	...
	public function hasOnlyDefaultValues()
	{
			...
			if ($this->del_type !== 'NORMAL') {
				return false;
			}

			if ($this->del_thread !== 0) {
				return false;
			}
			...
			if ($this->app_overdue_percentage !== 0) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->del_previous = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			...
			$this->del_type = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->del_thread = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
			$this->del_thread_status = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->del_priority = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			$this->del_delegate_date = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->del_init_date = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->del_task_due_date = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
			$this->del_finish_date = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
			$this->del_duration = ($row[$startcol + 14] !== null) ? (double) $row[$startcol + 14] : null;
			$this->del_queue_duration = ($row[$startcol + 15] !== null) ? (double) $row[$startcol + 15] : null;
			$this->del_delay_duration = ($row[$startcol + 16] !== null) ? (double) $row[$startcol + 16] : null;
			$this->del_started = ($row[$startcol + 17] !== null) ? (int) $row[$startcol + 17] : null;
			$this->del_finished = ($row[$startcol + 18] !== null) ? (int) $row[$startcol + 18] : null;
			$this->del_delayed = ($row[$startcol + 19] !== null) ? (int) $row[$startcol + 19] : null;
			$this->del_data = ($row[$startcol + 20] !== null) ? (string) $row[$startcol + 20] : null;
			$this->app_overdue_percentage = ($row[$startcol + 21] !== null) ? (double) $row[$startcol + 21] : null;
			$this->resetModified();
			...
			return $startcol + 22; // 22 = AppDelegationPeer::NUM_HYDRATE_COLUMNS.
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AppDelegationPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = AppDelegationQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				AppDelegationPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	{
		if (isset($alreadyDumpedObjects['AppDelegation'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['AppDelegation'][serialize($this->getPrimaryKey())] = true;
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		$copyObj->setDelPrevious($this->getDelPrevious());
		$copyObj->setProUid($this->getProUid());
		$copyObj->setTasUid($this->getTasUid());
		$copyObj->setUsrUid($this->getUsrUid());
		$copyObj->setDelType($this->getDelType());
		$copyObj->setDelThread($this->getDelThread());
		...
		$copyObj->setDelData($this->getDelData());
	...
	public function clear()
	{
		$this->app_uid = null;
		$this->del_index = null;
		$this->del_previous = null;
		$this->pro_uid = null;
		$this->tas_uid = null;
		$this->usr_uid = null;
		$this->del_type = null;
		$this->del_thread = null;
	...
	{
		return (string) $this->exportTo(AppDelegationPeer::DEFAULT_STRING_FORMAT);
	}
