...
require_once 'classes/model/map/DepartmentTableMap.php';
...
abstract class BaseDepartmentPeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_STUDLYPHPNAME => array ('depUid', 'depParent', 'depManager', 'depLocation', 'depStatus', 'depRefCode', 'depLdapDn', ),
        BasePeer::TYPE_COLNAME => array (self::DEP_UID, self::DEP_PARENT, self::DEP_MANAGER, self::DEP_LOCATION, self::DEP_STATUS, self::DEP_REF_CODE, self::DEP_LDAP_DN, ),
        BasePeer::TYPE_RAW_COLNAME => array ('DEP_UID', 'DEP_PARENT', 'DEP_MANAGER', 'DEP_LOCATION', 'DEP_STATUS', 'DEP_REF_CODE', 'DEP_LDAP_DN', ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_STUDLYPHPNAME => array ('depUid' => 0, 'depParent' => 1, 'depManager' => 2, 'depLocation' => 3, 'depStatus' => 4, 'depRefCode' => 5, 'depLdapDn' => 6, ),
        BasePeer::TYPE_COLNAME => array (self::DEP_UID => 0, self::DEP_PARENT => 1, self::DEP_MANAGER => 2, self::DEP_LOCATION => 3, self::DEP_STATUS => 4, self::DEP_REF_CODE => 5, self::DEP_LDAP_DN => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('DEP_UID' => 0, 'DEP_PARENT' => 1, 'DEP_MANAGER' => 2, 'DEP_LOCATION' => 3, 'DEP_STATUS' => 4, 'DEP_REF_CODE' => 5, 'DEP_LDAP_DN' => 6, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn($alias . '.DEP_PARENT');
            $criteria->addSelectColumn($alias . '.DEP_MANAGER');
            $criteria->addSelectColumn($alias . '.DEP_LOCATION');
            $criteria->addSelectColumn($alias . '.DEP_STATUS');
            $criteria->addSelectColumn($alias . '.DEP_REF_CODE');
            $criteria->addSelectColumn($alias . '.DEP_LDAP_DN');
        }
    }
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        $cls = DepartmentPeer::getOMClass(false);
    ...
    {
        return $withPrefix ? DepartmentPeer::CLASS_DEFAULT : DepartmentPeer::OM_CLASS;
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $value = $criteria->remove(DepartmentPeer::DEP_UID);
            if ($value) {
                $selectCriteria->add(DepartmentPeer::DEP_UID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(DepartmentPeer::TABLE_NAME);
            }

        } else {
            // $values is Department object
