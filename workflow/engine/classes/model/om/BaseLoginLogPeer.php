...
require_once 'classes/model/map/LoginLogTableMap.php';
...
abstract class BaseLoginLogPeer
{
    ...
    /**
     * An identiy map to hold any loaded instances of LoginLog objects.
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_STUDLYPHPNAME => array ('logUid', 'logStatus', 'logIp', 'logSid', 'logInitDate', 'logEndDate', 'logClientHostname', 'usrUid', ),
        BasePeer::TYPE_COLNAME => array (self::LOG_UID, self::LOG_STATUS, self::LOG_IP, self::LOG_SID, self::LOG_INIT_DATE, self::LOG_END_DATE, self::LOG_CLIENT_HOSTNAME, self::USR_UID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('LOG_UID', 'LOG_STATUS', 'LOG_IP', 'LOG_SID', 'LOG_INIT_DATE', 'LOG_END_DATE', 'LOG_CLIENT_HOSTNAME', 'USR_UID', ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_STUDLYPHPNAME => array ('logUid' => 0, 'logStatus' => 1, 'logIp' => 2, 'logSid' => 3, 'logInitDate' => 4, 'logEndDate' => 5, 'logClientHostname' => 6, 'usrUid' => 7, ),
        BasePeer::TYPE_COLNAME => array (self::LOG_UID => 0, self::LOG_STATUS => 1, self::LOG_IP => 2, self::LOG_SID => 3, self::LOG_INIT_DATE => 4, self::LOG_END_DATE => 5, self::LOG_CLIENT_HOSTNAME => 6, self::USR_UID => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('LOG_UID' => 0, 'LOG_STATUS' => 1, 'LOG_IP' => 2, 'LOG_SID' => 3, 'LOG_INIT_DATE' => 4, 'LOG_END_DATE' => 5, 'LOG_CLIENT_HOSTNAME' => 6, 'USR_UID' => 7, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn($alias . '.LOG_UID');
            $criteria->addSelectColumn($alias . '.LOG_STATUS');
            $criteria->addSelectColumn($alias . '.LOG_IP');
            $criteria->addSelectColumn($alias . '.LOG_SID');
            $criteria->addSelectColumn($alias . '.LOG_INIT_DATE');
            $criteria->addSelectColumn($alias . '.LOG_END_DATE');
            $criteria->addSelectColumn($alias . '.LOG_CLIENT_HOSTNAME');
     ...
     *
     * @param      LoginLog $value A LoginLog object.
    ...
    /**
     * Method to invalidate the instance pool of all tables related to LOGIN_LOG
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        $cls = LoginLogPeer::getOMClass(false);
    ...
    {
        return $withPrefix ? LoginLogPeer::CLASS_DEFAULT : LoginLogPeer::OM_CLASS;
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $value = $criteria->remove(LoginLogPeer::LOG_UID);
            if ($value) {
                $selectCriteria->add(LoginLogPeer::LOG_UID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(LoginLogPeer::TABLE_NAME);
            }

        } else {
            // $values is LoginLog object
