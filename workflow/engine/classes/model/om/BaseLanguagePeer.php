...
require_once 'classes/model/map/LanguageTableMap.php';
...
abstract class BaseLanguagePeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_STUDLYPHPNAME => array ('lanId', 'lanName', 'lanNativeName', 'lanDirection', 'lanWeight', 'lanEnabled', 'lanCalendar', ),
        BasePeer::TYPE_COLNAME => array (self::LAN_ID, self::LAN_NAME, self::LAN_NATIVE_NAME, self::LAN_DIRECTION, self::LAN_WEIGHT, self::LAN_ENABLED, self::LAN_CALENDAR, ),
        BasePeer::TYPE_RAW_COLNAME => array ('LAN_ID', 'LAN_NAME', 'LAN_NATIVE_NAME', 'LAN_DIRECTION', 'LAN_WEIGHT', 'LAN_ENABLED', 'LAN_CALENDAR', ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_STUDLYPHPNAME => array ('lanId' => 0, 'lanName' => 1, 'lanNativeName' => 2, 'lanDirection' => 3, 'lanWeight' => 4, 'lanEnabled' => 5, 'lanCalendar' => 6, ),
        BasePeer::TYPE_COLNAME => array (self::LAN_ID => 0, self::LAN_NAME => 1, self::LAN_NATIVE_NAME => 2, self::LAN_DIRECTION => 3, self::LAN_WEIGHT => 4, self::LAN_ENABLED => 5, self::LAN_CALENDAR => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('LAN_ID' => 0, 'LAN_NAME' => 1, 'LAN_NATIVE_NAME' => 2, 'LAN_DIRECTION' => 3, 'LAN_WEIGHT' => 4, 'LAN_ENABLED' => 5, 'LAN_CALENDAR' => 6, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn($alias . '.LAN_ID');
            $criteria->addSelectColumn($alias . '.LAN_NAME');
            $criteria->addSelectColumn($alias . '.LAN_NATIVE_NAME');
            $criteria->addSelectColumn($alias . '.LAN_DIRECTION');
            $criteria->addSelectColumn($alias . '.LAN_WEIGHT');
            $criteria->addSelectColumn($alias . '.LAN_ENABLED');
            $criteria->addSelectColumn($alias . '.LAN_CALENDAR');
        }
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $value = $criteria->remove(LanguagePeer::LAN_ID);
            if ($value) {
                $selectCriteria->add(LanguagePeer::LAN_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(LanguagePeer::TABLE_NAME);
            }

        } else {
            // $values is Language object
