...
abstract class BaseCalendarBusinessHours extends BaseObject  implements Persistent
{
	 ...
	 * Peer class name
	 */
	const PEER = 'CalendarBusinessHoursPeer';
	...
	{
		$this->calendar_uid = '';
		$this->calendar_business_day = '';
		$this->calendar_business_start = '';
		$this->calendar_business_end = '';
	}

	/**
	 * Initializes internal state of BaseCalendarBusinessHours object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     CalendarBusinessHours The current object (for fluent API support)
	 */
	...
	public function setCalendarBusinessDay($v)
	{
		...
		if ($this->calendar_business_day !== $v) {
	...
	public function setCalendarBusinessStart($v)
	{
		...
		if ($this->calendar_business_start !== $v) {
	...
	public function setCalendarBusinessEnd($v)
	{
		...
		if ($this->calendar_business_end !== $v) {
	...
	public function hasOnlyDefaultValues()
	{
			...
			if ($this->calendar_business_day !== '') {
				return false;
			}

			if ($this->calendar_business_start !== '') {
				return false;
			}

			if ($this->calendar_business_end !== '') {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->calendar_business_day = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->calendar_business_start = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->calendar_business_end = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->resetModified();
			...
			return $startcol + 4; // 4 = CalendarBusinessHoursPeer::NUM_HYDRATE_COLUMNS.
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = CalendarBusinessHoursPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = CalendarBusinessHoursQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				CalendarBusinessHoursPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	{
		if (isset($alreadyDumpedObjects['CalendarBusinessHours'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['CalendarBusinessHours'][serialize($this->getPrimaryKey())] = true;
	...
	{
		return (null === $this->getCalendarUid()) && (null === $this->getCalendarBusinessDay()) && (null === $this->getCalendarBusinessStart()) && (null === $this->getCalendarBusinessEnd());
	}
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		$copyObj->setCalendarBusinessDay($this->getCalendarBusinessDay());
		$copyObj->setCalendarBusinessStart($this->getCalendarBusinessStart());
		$copyObj->setCalendarBusinessEnd($this->getCalendarBusinessEnd());
		if ($makeNew) {
			$copyObj->setNew(true);
		}
	}
	...
	public function clear()
	{
		...
		$this->calendar_business_day = null;
		$this->calendar_business_start = null;
		$this->calendar_business_end = null;
		$this->alreadyInSave = false;
		$this->alreadyInValidation = false;
	...
	{
		return (string) $this->exportTo(CalendarBusinessHoursPeer::DEFAULT_STRING_FORMAT);
	}
