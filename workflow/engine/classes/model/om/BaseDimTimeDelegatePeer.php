...
require_once 'classes/model/map/DimTimeDelegateTableMap.php';
...
abstract class BaseDimTimeDelegatePeer
{
    ...
    const OM_CLASS = 'DimTimeDelegate';

    /** A class that can be returned by this peer. */
    const CLASS_DEFAULT = 'classes.model.DimTimeDelegate';

    /** the related TableMap class for this table */
    const TM_CLASS = 'DimTimeDelegateTableMap';
    ...
    /**
     * An identiy map to hold any loaded instances of DimTimeDelegate objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array DimTimeDelegate[]
     */
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setPrimaryTableName(DimTimeDelegatePeer::TABLE_NAME);
        ...
        if ($con === null) {
            $con = Propel::getConnection(DimTimeDelegatePeer::DATABASE_NAME, Propel::CONNECTION_READ);
        }
    ...
    {
        return DimTimeDelegatePeer::populateObjects(DimTimeDelegatePeer::doSelectStmt($criteria, $con));
    }
    /**
     ...
     *
     * @param      DimTimeDelegate $value A DimTimeDelegate object.
     ...
     *
     * @param      mixed $value A DimTimeDelegate object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof DimTimeDelegate) {
                $key = (string) $value->getTimeId();
            } elseif (is_scalar($value)) {
                // assume we've been passed a primary key
                $key = (string) $value;
            } else {
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or DimTimeDelegate object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
                throw $e;
            }
     ...
     * @return     DimTimeDelegate Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
    ...
    /**
     * Method to invalidate the instance pool of all tables related to DIM_TIME_DELEGATE
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        $cls = DimTimeDelegatePeer::getOMClass(false);
        // populate the object(s)
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key = DimTimeDelegatePeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj = DimTimeDelegatePeer::getInstanceFromPool($key))) {
                ...
                $obj->hydrate($row);
                $results[] = $obj;
                DimTimeDelegatePeer::addInstanceToPool($obj, $key);
            } // if key exists
        }
        $stmt->closeCursor();
        return $results;
     ...
     * @throws     PropelException Any exceptions caught during processing will be
     *             rethrown wrapped into a PropelException.
     * @return     array (DimTimeDelegate object, last column rank)
     */
    public static function populateObject($row, $startcol = 0)
    {
        $key = DimTimeDelegatePeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = DimTimeDelegatePeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + DimTimeDelegatePeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = DimTimeDelegatePeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        $dbMap = Propel::getDatabaseMap(BaseDimTimeDelegatePeer::DATABASE_NAME);
        if (!$dbMap->hasTable(BaseDimTimeDelegatePeer::TABLE_NAME)) {
            $dbMap->addTableObject(new DimTimeDelegateTableMap());
        }
    }
    ...
    {
        return $withPrefix ? DimTimeDelegatePeer::CLASS_DEFAULT : DimTimeDelegatePeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a DimTimeDelegate or Criteria object.
     *
    ...
    {
        if ($con === null) {
            $con = Propel::getConnection(DimTimeDelegatePeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
        }
    ...
    /**
     * Performs an UPDATE on the database, given a DimTimeDelegate or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $value = $criteria->remove(DimTimeDelegatePeer::TIME_ID);
            if ($value) {
                $selectCriteria->add(DimTimeDelegatePeer::TIME_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(DimTimeDelegatePeer::TABLE_NAME);
            }

        } else {
            // $values is DimTimeDelegate object
    ...
    /**
     * Deletes all rows from the DIM_TIME_DELEGATE table.
     *
     * @param      PropelPDO $con the connection to use
     * @return     int The number of affected rows (if supported by underlying database driver).
     */
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(DimTimeDelegatePeer::TABLE_NAME, $con, DimTimeDelegatePeer::DATABASE_NAME);
            // Because this db requires some delete cascade/set null emulation, we have to
            // clear the cached instance *after* the emulation has happened (since
            // instances get re-added by the select statement contained therein).
            DimTimeDelegatePeer::clearInstancePool();
            DimTimeDelegatePeer::clearRelatedInstancePool();
            $con->commit();
            return $affectedRows;
        } catch (PropelException $e) {
            $con->rollBack();
    ...
    /**
     * Performs a DELETE on the database, given a DimTimeDelegate or Criteria object OR a primary key value.
     *
    ...
    public static function doDelete($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
        ...
        } elseif ($values instanceof DimTimeDelegate) { // it's a model object
            // invalidate the cache for this single object
            DimTimeDelegatePeer::removeInstanceFromPool($values);
            ...
            foreach ((array) $values as $singleval) {
                DimTimeDelegatePeer::removeInstanceFromPool($singleval);
            }
        }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = DimTimeDelegatePeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
...
//
BaseDimTimeDelegatePeer::buildTableMap();
