...
abstract class BaseUsersPeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_STUDLYPHPNAME => array ('usrUid', 'usrUsername', 'usrPassword', 'usrFirstname', 'usrLastname', 'usrEmail', 'usrDueDate', 'usrCreateDate', 'usrUpdateDate', 'usrStatus', 'usrCountry', 'usrCity', 'usrLocation', 'usrAddress', 'usrPhone', 'usrFax', 'usrCellular', 'usrZipCode', 'depUid', 'usrPosition', 'usrResume', 'usrBirthday', 'usrRole', 'usrReportsTo', 'usrReplacedBy', 'usrUx', ),
        BasePeer::TYPE_COLNAME => array (self::USR_UID, self::USR_USERNAME, self::USR_PASSWORD, self::USR_FIRSTNAME, self::USR_LASTNAME, self::USR_EMAIL, self::USR_DUE_DATE, self::USR_CREATE_DATE, self::USR_UPDATE_DATE, self::USR_STATUS, self::USR_COUNTRY, self::USR_CITY, self::USR_LOCATION, self::USR_ADDRESS, self::USR_PHONE, self::USR_FAX, self::USR_CELLULAR, self::USR_ZIP_CODE, self::DEP_UID, self::USR_POSITION, self::USR_RESUME, self::USR_BIRTHDAY, self::USR_ROLE, self::USR_REPORTS_TO, self::USR_REPLACED_BY, self::USR_UX, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USR_UID', 'USR_USERNAME', 'USR_PASSWORD', 'USR_FIRSTNAME', 'USR_LASTNAME', 'USR_EMAIL', 'USR_DUE_DATE', 'USR_CREATE_DATE', 'USR_UPDATE_DATE', 'USR_STATUS', 'USR_COUNTRY', 'USR_CITY', 'USR_LOCATION', 'USR_ADDRESS', 'USR_PHONE', 'USR_FAX', 'USR_CELLULAR', 'USR_ZIP_CODE', 'DEP_UID', 'USR_POSITION', 'USR_RESUME', 'USR_BIRTHDAY', 'USR_ROLE', 'USR_REPORTS_TO', 'USR_REPLACED_BY', 'USR_UX', ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_STUDLYPHPNAME => array ('usrUid' => 0, 'usrUsername' => 1, 'usrPassword' => 2, 'usrFirstname' => 3, 'usrLastname' => 4, 'usrEmail' => 5, 'usrDueDate' => 6, 'usrCreateDate' => 7, 'usrUpdateDate' => 8, 'usrStatus' => 9, 'usrCountry' => 10, 'usrCity' => 11, 'usrLocation' => 12, 'usrAddress' => 13, 'usrPhone' => 14, 'usrFax' => 15, 'usrCellular' => 16, 'usrZipCode' => 17, 'depUid' => 18, 'usrPosition' => 19, 'usrResume' => 20, 'usrBirthday' => 21, 'usrRole' => 22, 'usrReportsTo' => 23, 'usrReplacedBy' => 24, 'usrUx' => 25, ),
        BasePeer::TYPE_COLNAME => array (self::USR_UID => 0, self::USR_USERNAME => 1, self::USR_PASSWORD => 2, self::USR_FIRSTNAME => 3, self::USR_LASTNAME => 4, self::USR_EMAIL => 5, self::USR_DUE_DATE => 6, self::USR_CREATE_DATE => 7, self::USR_UPDATE_DATE => 8, self::USR_STATUS => 9, self::USR_COUNTRY => 10, self::USR_CITY => 11, self::USR_LOCATION => 12, self::USR_ADDRESS => 13, self::USR_PHONE => 14, self::USR_FAX => 15, self::USR_CELLULAR => 16, self::USR_ZIP_CODE => 17, self::DEP_UID => 18, self::USR_POSITION => 19, self::USR_RESUME => 20, self::USR_BIRTHDAY => 21, self::USR_ROLE => 22, self::USR_REPORTS_TO => 23, self::USR_REPLACED_BY => 24, self::USR_UX => 25, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USR_UID' => 0, 'USR_USERNAME' => 1, 'USR_PASSWORD' => 2, 'USR_FIRSTNAME' => 3, 'USR_LASTNAME' => 4, 'USR_EMAIL' => 5, 'USR_DUE_DATE' => 6, 'USR_CREATE_DATE' => 7, 'USR_UPDATE_DATE' => 8, 'USR_STATUS' => 9, 'USR_COUNTRY' => 10, 'USR_CITY' => 11, 'USR_LOCATION' => 12, 'USR_ADDRESS' => 13, 'USR_PHONE' => 14, 'USR_FAX' => 15, 'USR_CELLULAR' => 16, 'USR_ZIP_CODE' => 17, 'DEP_UID' => 18, 'USR_POSITION' => 19, 'USR_RESUME' => 20, 'USR_BIRTHDAY' => 21, 'USR_ROLE' => 22, 'USR_REPORTS_TO' => 23, 'USR_REPLACED_BY' => 24, 'USR_UX' => 25, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn($alias . '.USR_COUNTRY');
            $criteria->addSelectColumn($alias . '.USR_CITY');
            $criteria->addSelectColumn($alias . '.USR_LOCATION');
            $criteria->addSelectColumn($alias . '.USR_ADDRESS');
            $criteria->addSelectColumn($alias . '.USR_PHONE');
            $criteria->addSelectColumn($alias . '.USR_FAX');
            $criteria->addSelectColumn($alias . '.USR_CELLULAR');
            $criteria->addSelectColumn($alias . '.USR_ZIP_CODE');
            $criteria->addSelectColumn($alias . '.DEP_UID');
            $criteria->addSelectColumn($alias . '.USR_POSITION');
            $criteria->addSelectColumn($alias . '.USR_RESUME');
            $criteria->addSelectColumn($alias . '.USR_BIRTHDAY');
            $criteria->addSelectColumn($alias . '.USR_ROLE');
            $criteria->addSelectColumn($alias . '.USR_REPORTS_TO');
            $criteria->addSelectColumn($alias . '.USR_REPLACED_BY');
            $criteria->addSelectColumn($alias . '.USR_UX');
        }
    }
