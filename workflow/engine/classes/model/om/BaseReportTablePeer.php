...
require_once 'classes/model/map/ReportTableTableMap.php';
...
abstract class BaseReportTablePeer
{
    ...
    /**
     * An identiy map to hold any loaded instances of ReportTable objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array ReportTable[]
     */
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_STUDLYPHPNAME => array ('repTabUid', 'proUid', 'repTabName', 'repTabType', 'repTabGrid', 'repTabConnection', 'repTabCreateDate', 'repTabStatus', ),
        BasePeer::TYPE_COLNAME => array (self::REP_TAB_UID, self::PRO_UID, self::REP_TAB_NAME, self::REP_TAB_TYPE, self::REP_TAB_GRID, self::REP_TAB_CONNECTION, self::REP_TAB_CREATE_DATE, self::REP_TAB_STATUS, ),
        BasePeer::TYPE_RAW_COLNAME => array ('REP_TAB_UID', 'PRO_UID', 'REP_TAB_NAME', 'REP_TAB_TYPE', 'REP_TAB_GRID', 'REP_TAB_CONNECTION', 'REP_TAB_CREATE_DATE', 'REP_TAB_STATUS', ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_STUDLYPHPNAME => array ('repTabUid' => 0, 'proUid' => 1, 'repTabName' => 2, 'repTabType' => 3, 'repTabGrid' => 4, 'repTabConnection' => 5, 'repTabCreateDate' => 6, 'repTabStatus' => 7, ),
        BasePeer::TYPE_COLNAME => array (self::REP_TAB_UID => 0, self::PRO_UID => 1, self::REP_TAB_NAME => 2, self::REP_TAB_TYPE => 3, self::REP_TAB_GRID => 4, self::REP_TAB_CONNECTION => 5, self::REP_TAB_CREATE_DATE => 6, self::REP_TAB_STATUS => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('REP_TAB_UID' => 0, 'PRO_UID' => 1, 'REP_TAB_NAME' => 2, 'REP_TAB_TYPE' => 3, 'REP_TAB_GRID' => 4, 'REP_TAB_CONNECTION' => 5, 'REP_TAB_CREATE_DATE' => 6, 'REP_TAB_STATUS' => 7, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn($alias . '.REP_TAB_UID');
            $criteria->addSelectColumn($alias . '.PRO_UID');
            $criteria->addSelectColumn($alias . '.REP_TAB_NAME');
            $criteria->addSelectColumn($alias . '.REP_TAB_TYPE');
            $criteria->addSelectColumn($alias . '.REP_TAB_GRID');
            $criteria->addSelectColumn($alias . '.REP_TAB_CONNECTION');
            $criteria->addSelectColumn($alias . '.REP_TAB_CREATE_DATE');
            $criteria->addSelectColumn($alias . '.REP_TAB_STATUS');
        }
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setPrimaryTableName(ReportTablePeer::TABLE_NAME);
        ...
        if ($con === null) {
            $con = Propel::getConnection(ReportTablePeer::DATABASE_NAME, Propel::CONNECTION_READ);
        }
    ...
    {
        return ReportTablePeer::populateObjects(ReportTablePeer::doSelectStmt($criteria, $con));
    }
    /**
     ...
     *
     * @param      ReportTable $value A ReportTable object.
     ...
     *
     * @param      mixed $value A ReportTable object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof ReportTable) {
                $key = (string) $value->getRepTabUid();
            } elseif (is_scalar($value)) {
                // assume we've been passed a primary key
                $key = (string) $value;
            } else {
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or ReportTable object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
                throw $e;
            }
     ...
     * @return     ReportTable Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
    ...
    /**
     * Method to invalidate the instance pool of all tables related to REPORT_TABLE
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        $cls = ReportTablePeer::getOMClass(false);
        // populate the object(s)
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key = ReportTablePeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj = ReportTablePeer::getInstanceFromPool($key))) {
                ...
                $obj->hydrate($row);
                $results[] = $obj;
                ReportTablePeer::addInstanceToPool($obj, $key);
            } // if key exists
        }
        $stmt->closeCursor();
        return $results;
     ...
     * @throws     PropelException Any exceptions caught during processing will be
     *             rethrown wrapped into a PropelException.
     * @return     array (ReportTable object, last column rank)
     */
    public static function populateObject($row, $startcol = 0)
    {
        $key = ReportTablePeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = ReportTablePeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + ReportTablePeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = ReportTablePeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        $dbMap = Propel::getDatabaseMap(BaseReportTablePeer::DATABASE_NAME);
        if (!$dbMap->hasTable(BaseReportTablePeer::TABLE_NAME)) {
            $dbMap->addTableObject(new ReportTableTableMap());
        }
    }
    ...
    {
        return $withPrefix ? ReportTablePeer::CLASS_DEFAULT : ReportTablePeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a ReportTable or Criteria object.
     *
    ...
    {
        if ($con === null) {
            $con = Propel::getConnection(ReportTablePeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
        }
    ...
    /**
     * Performs an UPDATE on the database, given a ReportTable or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $value = $criteria->remove(ReportTablePeer::REP_TAB_UID);
            if ($value) {
                $selectCriteria->add(ReportTablePeer::REP_TAB_UID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(ReportTablePeer::TABLE_NAME);
            }

        } else {
            // $values is ReportTable object
    ...
    /**
     * Deletes all rows from the REPORT_TABLE table.
     *
     * @param      PropelPDO $con the connection to use
     * @return     int The number of affected rows (if supported by underlying database driver).
     */
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(ReportTablePeer::TABLE_NAME, $con, ReportTablePeer::DATABASE_NAME);
            // Because this db requires some delete cascade/set null emulation, we have to
            // clear the cached instance *after* the emulation has happened (since
            // instances get re-added by the select statement contained therein).
            ReportTablePeer::clearInstancePool();
            ReportTablePeer::clearRelatedInstancePool();
            $con->commit();
            return $affectedRows;
        } catch (PropelException $e) {
            $con->rollBack();
    ...
    /**
     * Performs a DELETE on the database, given a ReportTable or Criteria object OR a primary key value.
     *
    ...
    public static function doDelete($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
        ...
        } elseif ($values instanceof ReportTable) { // it's a model object
            // invalidate the cache for this single object
            ReportTablePeer::removeInstanceFromPool($values);
            ...
            foreach ((array) $values as $singleval) {
                ReportTablePeer::removeInstanceFromPool($singleval);
            }
        }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = ReportTablePeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
...
//
BaseReportTablePeer::buildTableMap();
