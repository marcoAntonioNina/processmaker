...
abstract class BaseTriggers extends BaseObject  implements Persistent
{
	...
	public function applyDefaultValues()
	{
		$this->tri_uid = '';
		$this->pro_uid = '';
		$this->tri_type = 'SCRIPT';
	}

	/**
	 * Initializes internal state of BaseTriggers object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Triggers The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->tri_uid = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			$this->pro_uid = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->tri_type = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->tri_webbot = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->tri_param = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->resetModified();
			...
			return $startcol + 5; // 5 = TriggersPeer::NUM_HYDRATE_COLUMNS.
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TriggersPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = TriggersQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				TriggersPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	{
		if (isset($alreadyDumpedObjects['Triggers'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Triggers'][$this->getPrimaryKey()] = true;
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		$copyObj->setTriType($this->getTriType());
		$copyObj->setTriWebbot($this->getTriWebbot());
		$copyObj->setTriParam($this->getTriParam());
		if ($makeNew) {
			$copyObj->setNew(true);
		}
	}
	...
	{
		return (string) $this->exportTo(TriggersPeer::DEFAULT_STRING_FORMAT);
	}
