...
require_once 'classes/model/map/ContentTableMap.php';
...
abstract class BaseContentPeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_STUDLYPHPNAME => array ('conCategory', 'conParent', 'conId', 'conLang', 'conValue', ),
        BasePeer::TYPE_COLNAME => array (self::CON_CATEGORY, self::CON_PARENT, self::CON_ID, self::CON_LANG, self::CON_VALUE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('CON_CATEGORY', 'CON_PARENT', 'CON_ID', 'CON_LANG', 'CON_VALUE', ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_STUDLYPHPNAME => array ('conCategory' => 0, 'conParent' => 1, 'conId' => 2, 'conLang' => 3, 'conValue' => 4, ),
        BasePeer::TYPE_COLNAME => array (self::CON_CATEGORY => 0, self::CON_PARENT => 1, self::CON_ID => 2, self::CON_LANG => 3, self::CON_VALUE => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('CON_CATEGORY' => 0, 'CON_PARENT' => 1, 'CON_ID' => 2, 'CON_LANG' => 3, 'CON_VALUE' => 4, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn($alias . '.CON_CATEGORY');
            $criteria->addSelectColumn($alias . '.CON_PARENT');
            $criteria->addSelectColumn($alias . '.CON_ID');
            $criteria->addSelectColumn($alias . '.CON_LANG');
            $criteria->addSelectColumn($alias . '.CON_VALUE');
        }
    }
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if ($key === null) {
                $key = serialize(array((string) $obj->getConCategory(), (string) $obj->getConParent(), (string) $obj->getConId(), (string) $obj->getConLang()));
            } // if key === null
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof Content) {
                $key = serialize(array((string) $value->getConCategory(), (string) $value->getConParent(), (string) $value->getConId(), (string) $value->getConLang()));
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $value = $criteria->remove(ContentPeer::CON_CATEGORY);
            if ($value) {
                $selectCriteria->add(ContentPeer::CON_CATEGORY, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(ContentPeer::TABLE_NAME);
            }

            $comparison = $criteria->getComparison(ContentPeer::CON_PARENT);
            $value = $criteria->remove(ContentPeer::CON_PARENT);
            if ($value) {
                $selectCriteria->add(ContentPeer::CON_PARENT, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(ContentPeer::TABLE_NAME);
            }

            $comparison = $criteria->getComparison(ContentPeer::CON_ID);
            $value = $criteria->remove(ContentPeer::CON_ID);
            if ($value) {
                $selectCriteria->add(ContentPeer::CON_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(ContentPeer::TABLE_NAME);
            }

            $comparison = $criteria->getComparison(ContentPeer::CON_LANG);
            $value = $criteria->remove(ContentPeer::CON_LANG);
            if ($value) {
                $selectCriteria->add(ContentPeer::CON_LANG, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(ContentPeer::TABLE_NAME);
            }

        } else {
            // $values is Content object
    ...
    public static function doDelete($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(ContentPeer::CON_CATEGORY, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(ContentPeer::CON_PARENT, $value[1]));
                $criterion->addAnd($criteria->getNewCriterion(ContentPeer::CON_ID, $value[2]));
                $criterion->addAnd($criteria->getNewCriterion(ContentPeer::CON_LANG, $value[3]));
                $criteria->addOr($criterion);
                // we can invalidate the cache for this single PK
                ContentPeer::removeInstanceFromPool($value);
            }
        }
     ...
     * @return     Content
     */
    public static function retrieveByPK($con_category, $con_parent, $con_id, $con_lang, PropelPDO $con = null) {
        $_instancePoolKey = serialize(array((string) $con_category, (string) $con_parent, (string) $con_id, (string) $con_lang));
        if (null !== ($obj = ContentPeer::getInstanceFromPool($_instancePoolKey))) {
            return $obj;
        }
