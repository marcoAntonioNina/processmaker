...
abstract class BaseStep extends BaseObject  implements Persistent
{
	 ...
	 * Note: this column has a database default value of: 'EDIT'
	 * @var        string
	 */
	protected $step_mode;
	...
	/**
	 * Initializes internal state of BaseStep object.
	 * @see        applyDefaults()
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->step_type_obj = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->step_uid_obj = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->step_condition = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->step_position = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			$this->step_mode = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->resetModified();
			...
			return $startcol + 8; // 8 = StepPeer::NUM_HYDRATE_COLUMNS.
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		$copyObj->setStepCondition($this->getStepCondition());
		$copyObj->setStepPosition($this->getStepPosition());
		$copyObj->setStepMode($this->getStepMode());
		if ($makeNew) {
			$copyObj->setNew(true);
		}
	}
