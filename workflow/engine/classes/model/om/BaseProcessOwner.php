...
abstract class BaseProcessOwner extends BaseObject  implements Persistent
{
	...
	/**
	 * Initializes internal state of BaseProcessOwner object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     ProcessOwner The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->own_uid = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			...
			return $startcol + 2; // 2 = ProcessOwnerPeer::NUM_HYDRATE_COLUMNS.
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ProcessOwnerPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = ProcessOwnerQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ProcessOwnerPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	{
		if (isset($alreadyDumpedObjects['ProcessOwner'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['ProcessOwner'][serialize($this->getPrimaryKey())] = true;
	...
	{
		return (null === $this->getOwnUid()) && (null === $this->getProUid());
	}
	...
	{
		$copyObj->setOwnUid($this->getOwnUid());
	...
	{
		return (string) $this->exportTo(ProcessOwnerPeer::DEFAULT_STRING_FORMAT);
	}
