...
abstract class BaseProcessUser extends BaseObject  implements Persistent
{
	...
	/**
	 * Initializes internal state of BaseProcessUser object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     ProcessUser The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = ProcessUserPeer::NUM_HYDRATE_COLUMNS.
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ProcessUserPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = ProcessUserQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ProcessUserPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	{
		if (isset($alreadyDumpedObjects['ProcessUser'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['ProcessUser'][$this->getPrimaryKey()] = true;
	...
	{
		return (string) $this->exportTo(ProcessUserPeer::DEFAULT_STRING_FORMAT);
	}
