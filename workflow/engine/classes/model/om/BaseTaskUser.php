...
abstract class BaseTaskUser extends BaseObject  implements Persistent
{
	...
	/**
	 * Initializes internal state of BaseTaskUser object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     TaskUser The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->tas_uid = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			$this->usr_uid = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->tu_type = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->tu_relation = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->resetModified();
			...
			return $startcol + 4; // 4 = TaskUserPeer::NUM_HYDRATE_COLUMNS.
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TaskUserPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = TaskUserQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				TaskUserPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	{
		if (isset($alreadyDumpedObjects['TaskUser'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['TaskUser'][serialize($this->getPrimaryKey())] = true;
	...
	{
		return (null === $this->getTasUid()) && (null === $this->getUsrUid()) && (null === $this->getTuType()) && (null === $this->getTuRelation());
	}
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		$copyObj->setTuType($this->getTuType());
		$copyObj->setTuRelation($this->getTuRelation());
		if ($makeNew) {
			$copyObj->setNew(true);
		}
	}
	...
	{
		return (string) $this->exportTo(TaskUserPeer::DEFAULT_STRING_FORMAT);
	}
