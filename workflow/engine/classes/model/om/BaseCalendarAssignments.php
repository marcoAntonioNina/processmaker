...
abstract class BaseCalendarAssignments extends BaseObject  implements Persistent
{
	 ...
	 * Peer class name
	 */
	const PEER = 'CalendarAssignmentsPeer';
	...
	/**
	 * Initializes internal state of BaseCalendarAssignments object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     CalendarAssignments The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->object_uid = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			$this->calendar_uid = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			...
			return $startcol + 3; // 3 = CalendarAssignmentsPeer::NUM_HYDRATE_COLUMNS.
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = CalendarAssignmentsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = CalendarAssignmentsQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				CalendarAssignmentsPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	{
		if (isset($alreadyDumpedObjects['CalendarAssignments'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['CalendarAssignments'][$this->getPrimaryKey()] = true;
	...
	{
		$copyObj->setObjectUid($this->getObjectUid());
	...
	{
		return (string) $this->exportTo(CalendarAssignmentsPeer::DEFAULT_STRING_FORMAT);
	}
