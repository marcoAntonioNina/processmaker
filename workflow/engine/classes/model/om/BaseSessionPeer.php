...
require_once 'classes/model/map/SessionTableMap.php';
...
abstract class BaseSessionPeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_STUDLYPHPNAME => array ('sesUid', 'sesStatus', 'usrUid', 'sesRemoteIp', 'sesInitDate', 'sesDueDate', 'sesEndDate', ),
        BasePeer::TYPE_COLNAME => array (self::SES_UID, self::SES_STATUS, self::USR_UID, self::SES_REMOTE_IP, self::SES_INIT_DATE, self::SES_DUE_DATE, self::SES_END_DATE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('SES_UID', 'SES_STATUS', 'USR_UID', 'SES_REMOTE_IP', 'SES_INIT_DATE', 'SES_DUE_DATE', 'SES_END_DATE', ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_STUDLYPHPNAME => array ('sesUid' => 0, 'sesStatus' => 1, 'usrUid' => 2, 'sesRemoteIp' => 3, 'sesInitDate' => 4, 'sesDueDate' => 5, 'sesEndDate' => 6, ),
        BasePeer::TYPE_COLNAME => array (self::SES_UID => 0, self::SES_STATUS => 1, self::USR_UID => 2, self::SES_REMOTE_IP => 3, self::SES_INIT_DATE => 4, self::SES_DUE_DATE => 5, self::SES_END_DATE => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('SES_UID' => 0, 'SES_STATUS' => 1, 'USR_UID' => 2, 'SES_REMOTE_IP' => 3, 'SES_INIT_DATE' => 4, 'SES_DUE_DATE' => 5, 'SES_END_DATE' => 6, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn($alias . '.SES_UID');
            $criteria->addSelectColumn($alias . '.SES_STATUS');
            $criteria->addSelectColumn($alias . '.USR_UID');
            $criteria->addSelectColumn($alias . '.SES_REMOTE_IP');
            $criteria->addSelectColumn($alias . '.SES_INIT_DATE');
            $criteria->addSelectColumn($alias . '.SES_DUE_DATE');
            $criteria->addSelectColumn($alias . '.SES_END_DATE');
        }
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $value = $criteria->remove(SessionPeer::SES_UID);
            if ($value) {
                $selectCriteria->add(SessionPeer::SES_UID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(SessionPeer::TABLE_NAME);
            }

        } else {
            // $values is Session object
