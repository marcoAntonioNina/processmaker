...
abstract class BaseLanguage extends BaseObject  implements Persistent
{
	 ...
	 * @var        string
	 */
	protected $lan_enabled;

	/**
	 * The value for the lan_calendar field.
	 * Note: this column has a database default value of: 'GREGORIAN'
	 * @var        string
	 */
	protected $lan_calendar;
	...
	public function applyDefaultValues()
	{
		$this->lan_id = '';
		$this->lan_name = '';
		$this->lan_native_name = '';
		$this->lan_direction = 'L';
		$this->lan_weight = 0;
		$this->lan_enabled = '1';
		$this->lan_calendar = 'GREGORIAN';
	}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if ($this->lan_native_name !== '') {
				return false;
			}

			if ($this->lan_direction !== 'L') {
				return false;
			}

			if ($this->lan_weight !== 0) {
				return false;
			}

			if ($this->lan_enabled !== '1') {
				return false;
			}

			if ($this->lan_calendar !== 'GREGORIAN') {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->lan_id = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			$this->lan_name = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->lan_native_name = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->lan_direction = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->lan_weight = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->lan_enabled = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->lan_calendar = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->resetModified();
			...
			return $startcol + 7; // 7 = LanguagePeer::NUM_HYDRATE_COLUMNS.
	...
	{
		$copyObj->setLanId($this->getLanId());
		$copyObj->setLanName($this->getLanName());
		$copyObj->setLanNativeName($this->getLanNativeName());
		$copyObj->setLanDirection($this->getLanDirection());
		$copyObj->setLanWeight($this->getLanWeight());
		$copyObj->setLanEnabled($this->getLanEnabled());
		$copyObj->setLanCalendar($this->getLanCalendar());
		if ($makeNew) {
			$copyObj->setNew(true);
		}
	}
	...
	public function clear()
	{
		$this->lan_id = null;
		$this->lan_name = null;
		$this->lan_native_name = null;
		$this->lan_direction = null;
		$this->lan_weight = null;
		$this->lan_enabled = null;
		$this->lan_calendar = null;
		$this->alreadyInSave = false;
		$this->alreadyInValidation = false;
