...
abstract class BaseRoute extends BaseObject  implements Persistent
{
	 ...
	 * Note: this column has a database default value of: 'SEQUENTIAL'
	 * @var        string
	 */
	protected $rou_type;
	...
	public function applyDefaultValues()
	{
		...
		$this->pro_uid = '';
		$this->tas_uid = '';
		$this->rou_next_task = '0';
		$this->rou_case = 0;
		$this->rou_type = 'SEQUENTIAL';
		$this->rou_condition = '';
		$this->rou_to_last_user = 'FALSE';
		$this->rou_optional = 'FALSE';
		$this->rou_send_email = 'TRUE';
		$this->rou_sourceanchor = 1;
		$this->rou_targetanchor = 0;
		$this->rou_to_port = 1;
		$this->rou_from_port = 2;
		$this->rou_evn_uid = '';
		$this->gat_uid = '';
	}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if ($this->rou_type !== 'SEQUENTIAL') {
				return false;
			}

			if ($this->rou_condition !== '') {
				return false;
			}

			if ($this->rou_to_last_user !== 'FALSE') {
				return false;
			}

			if ($this->rou_optional !== 'FALSE') {
				return false;
			}

			if ($this->rou_send_email !== 'TRUE') {
				return false;
			}

			if ($this->rou_sourceanchor !== 1) {
				return false;
			}

			if ($this->rou_targetanchor !== 0) {
				return false;
			}

			if ($this->rou_to_port !== 1) {
				return false;
			}

			if ($this->rou_from_port !== 2) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->rou_uid = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			$this->rou_parent = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->pro_uid = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->tas_uid = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->rou_next_task = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->rou_case = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->rou_type = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->rou_condition = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->rou_to_last_user = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->rou_optional = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			$this->rou_send_email = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->rou_sourceanchor = ($row[$startcol + 11] !== null) ? (int) $row[$startcol + 11] : null;
			$this->rou_targetanchor = ($row[$startcol + 12] !== null) ? (int) $row[$startcol + 12] : null;
			$this->rou_to_port = ($row[$startcol + 13] !== null) ? (int) $row[$startcol + 13] : null;
			$this->rou_from_port = ($row[$startcol + 14] !== null) ? (int) $row[$startcol + 14] : null;
			$this->rou_evn_uid = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
			$this->gat_uid = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
			$this->resetModified();
			...
			return $startcol + 17; // 17 = RoutePeer::NUM_HYDRATE_COLUMNS.
	...
	{
		$copyObj->setRouUid($this->getRouUid());
		$copyObj->setRouParent($this->getRouParent());
		$copyObj->setProUid($this->getProUid());
		$copyObj->setTasUid($this->getTasUid());
		$copyObj->setRouNextTask($this->getRouNextTask());
		$copyObj->setRouCase($this->getRouCase());
		$copyObj->setRouType($this->getRouType());
		$copyObj->setRouCondition($this->getRouCondition());
		$copyObj->setRouToLastUser($this->getRouToLastUser());
		$copyObj->setRouOptional($this->getRouOptional());
		$copyObj->setRouSendEmail($this->getRouSendEmail());
		$copyObj->setRouSourceanchor($this->getRouSourceanchor());
		$copyObj->setRouTargetanchor($this->getRouTargetanchor());
		$copyObj->setRouToPort($this->getRouToPort());
		$copyObj->setRouFromPort($this->getRouFromPort());
		$copyObj->setRouEvnUid($this->getRouEvnUid());
		$copyObj->setGatUid($this->getGatUid());
		if ($makeNew) {
			$copyObj->setNew(true);
		}
	}
	...
	{
		$this->rou_uid = null;
		$this->rou_parent = null;
		$this->pro_uid = null;
		$this->tas_uid = null;
		$this->rou_next_task = null;
		$this->rou_case = null;
		$this->rou_type = null;
		$this->rou_condition = null;
		$this->rou_to_last_user = null;
		$this->rou_optional = null;
		$this->rou_send_email = null;
		$this->rou_sourceanchor = null;
		$this->rou_targetanchor = null;
		$this->rou_to_port = null;
		$this->rou_from_port = null;
		$this->rou_evn_uid = null;
		$this->gat_uid = null;
		$this->alreadyInSave = false;
		$this->alreadyInValidation = false;
