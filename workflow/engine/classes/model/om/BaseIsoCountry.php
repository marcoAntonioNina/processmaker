...
abstract class BaseIsoCountry extends BaseObject  implements Persistent
{
	...
	/**
	 * Initializes internal state of BaseIsoCountry object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     IsoCountry The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->ic_name = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->ic_sort_order = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->resetModified();
			...
			return $startcol + 3; // 3 = IsoCountryPeer::NUM_HYDRATE_COLUMNS.
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = IsoCountryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = IsoCountryQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				IsoCountryPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	{
		if (isset($alreadyDumpedObjects['IsoCountry'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['IsoCountry'][$this->getPrimaryKey()] = true;
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		$copyObj->setIcName($this->getIcName());
		$copyObj->setIcSortOrder($this->getIcSortOrder());
		if ($makeNew) {
			$copyObj->setNew(true);
		}
	}
	...
	{
		return (string) $this->exportTo(IsoCountryPeer::DEFAULT_STRING_FORMAT);
	}
