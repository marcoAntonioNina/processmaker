...
require_once 'classes/model/map/LogCasesSchedulerTableMap.php';
...
abstract class BaseLogCasesSchedulerPeer
{
    ...
    const OM_CLASS = 'LogCasesScheduler';

    /** A class that can be returned by this peer. */
    const CLASS_DEFAULT = 'classes.model.LogCasesScheduler';

    /** the related TableMap class for this table */
    const TM_CLASS = 'LogCasesSchedulerTableMap';
    ...
    /**
     * An identiy map to hold any loaded instances of LogCasesScheduler objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array LogCasesScheduler[]
     */
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_STUDLYPHPNAME => array ('logCaseUid', 'proUid', 'tasUid', 'usrName', 'execDate', 'execHour', 'result', 'schUid', 'wsCreateCaseStatus', 'wsRouteCaseStatus', ),
        BasePeer::TYPE_COLNAME => array (self::LOG_CASE_UID, self::PRO_UID, self::TAS_UID, self::USR_NAME, self::EXEC_DATE, self::EXEC_HOUR, self::RESULT, self::SCH_UID, self::WS_CREATE_CASE_STATUS, self::WS_ROUTE_CASE_STATUS, ),
        BasePeer::TYPE_RAW_COLNAME => array ('LOG_CASE_UID', 'PRO_UID', 'TAS_UID', 'USR_NAME', 'EXEC_DATE', 'EXEC_HOUR', 'RESULT', 'SCH_UID', 'WS_CREATE_CASE_STATUS', 'WS_ROUTE_CASE_STATUS', ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_STUDLYPHPNAME => array ('logCaseUid' => 0, 'proUid' => 1, 'tasUid' => 2, 'usrName' => 3, 'execDate' => 4, 'execHour' => 5, 'result' => 6, 'schUid' => 7, 'wsCreateCaseStatus' => 8, 'wsRouteCaseStatus' => 9, ),
        BasePeer::TYPE_COLNAME => array (self::LOG_CASE_UID => 0, self::PRO_UID => 1, self::TAS_UID => 2, self::USR_NAME => 3, self::EXEC_DATE => 4, self::EXEC_HOUR => 5, self::RESULT => 6, self::SCH_UID => 7, self::WS_CREATE_CASE_STATUS => 8, self::WS_ROUTE_CASE_STATUS => 9, ),
        BasePeer::TYPE_RAW_COLNAME => array ('LOG_CASE_UID' => 0, 'PRO_UID' => 1, 'TAS_UID' => 2, 'USR_NAME' => 3, 'EXEC_DATE' => 4, 'EXEC_HOUR' => 5, 'RESULT' => 6, 'SCH_UID' => 7, 'WS_CREATE_CASE_STATUS' => 8, 'WS_ROUTE_CASE_STATUS' => 9, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn($alias . '.LOG_CASE_UID');
            $criteria->addSelectColumn($alias . '.PRO_UID');
            $criteria->addSelectColumn($alias . '.TAS_UID');
            $criteria->addSelectColumn($alias . '.USR_NAME');
            $criteria->addSelectColumn($alias . '.EXEC_DATE');
            $criteria->addSelectColumn($alias . '.EXEC_HOUR');
            $criteria->addSelectColumn($alias . '.RESULT');
            $criteria->addSelectColumn($alias . '.SCH_UID');
            $criteria->addSelectColumn($alias . '.WS_CREATE_CASE_STATUS');
            $criteria->addSelectColumn($alias . '.WS_ROUTE_CASE_STATUS');
        }
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setPrimaryTableName(LogCasesSchedulerPeer::TABLE_NAME);
    ...
    {
        return LogCasesSchedulerPeer::populateObjects(LogCasesSchedulerPeer::doSelectStmt($criteria, $con));
    }
    /**
     ...
     *
     * @param      LogCasesScheduler $value A LogCasesScheduler object.
     ...
     *
     * @param      mixed $value A LogCasesScheduler object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof LogCasesScheduler) {
                $key = (string) $value->getLogCaseUid();
            } elseif (is_scalar($value)) {
                // assume we've been passed a primary key
                $key = (string) $value;
            } else {
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or LogCasesScheduler object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
                throw $e;
            }
     ...
     * @return     LogCasesScheduler Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
    ...
    /**
     * Method to invalidate the instance pool of all tables related to LOG_CASES_SCHEDULER
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        $cls = LogCasesSchedulerPeer::getOMClass(false);
        // populate the object(s)
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key = LogCasesSchedulerPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj = LogCasesSchedulerPeer::getInstanceFromPool($key))) {
                ...
                $obj->hydrate($row);
                $results[] = $obj;
                LogCasesSchedulerPeer::addInstanceToPool($obj, $key);
            } // if key exists
        }
        $stmt->closeCursor();
        return $results;
     ...
     * @throws     PropelException Any exceptions caught during processing will be
     *             rethrown wrapped into a PropelException.
     * @return     array (LogCasesScheduler object, last column rank)
     */
    public static function populateObject($row, $startcol = 0)
    {
        $key = LogCasesSchedulerPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = LogCasesSchedulerPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + LogCasesSchedulerPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = LogCasesSchedulerPeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        $dbMap = Propel::getDatabaseMap(BaseLogCasesSchedulerPeer::DATABASE_NAME);
        if (!$dbMap->hasTable(BaseLogCasesSchedulerPeer::TABLE_NAME)) {
            $dbMap->addTableObject(new LogCasesSchedulerTableMap());
        }
    }
    ...
    {
        return $withPrefix ? LogCasesSchedulerPeer::CLASS_DEFAULT : LogCasesSchedulerPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a LogCasesScheduler or Criteria object.
     *
    ...
    /**
     * Performs an UPDATE on the database, given a LogCasesScheduler or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $value = $criteria->remove(LogCasesSchedulerPeer::LOG_CASE_UID);
            if ($value) {
                $selectCriteria->add(LogCasesSchedulerPeer::LOG_CASE_UID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(LogCasesSchedulerPeer::TABLE_NAME);
            }

        } else {
            // $values is LogCasesScheduler object
    ...
    /**
     * Deletes all rows from the LOG_CASES_SCHEDULER table.
     *
     * @param      PropelPDO $con the connection to use
     * @return     int The number of affected rows (if supported by underlying database driver).
     */
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(LogCasesSchedulerPeer::TABLE_NAME, $con, LogCasesSchedulerPeer::DATABASE_NAME);
            // Because this db requires some delete cascade/set null emulation, we have to
            // clear the cached instance *after* the emulation has happened (since
            // instances get re-added by the select statement contained therein).
            LogCasesSchedulerPeer::clearInstancePool();
            LogCasesSchedulerPeer::clearRelatedInstancePool();
            $con->commit();
            return $affectedRows;
        } catch (PropelException $e) {
            $con->rollBack();
    ...
    /**
     * Performs a DELETE on the database, given a LogCasesScheduler or Criteria object OR a primary key value.
     *
    ...
    public static function doDelete($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
        ...
        } elseif ($values instanceof LogCasesScheduler) { // it's a model object
            // invalidate the cache for this single object
            LogCasesSchedulerPeer::removeInstanceFromPool($values);
            ...
            foreach ((array) $values as $singleval) {
                LogCasesSchedulerPeer::removeInstanceFromPool($singleval);
            }
        }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = LogCasesSchedulerPeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
...
//
BaseLogCasesSchedulerPeer::buildTableMap();
