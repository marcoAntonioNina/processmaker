...
abstract class BaseProcessCategory extends BaseObject  implements Persistent
{
	 ...
	 * Peer class name
	 */
	const PEER = 'ProcessCategoryPeer';
	...
	/**
	 * Initializes internal state of BaseProcessCategory object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     ProcessCategory The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->category_uid = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			$this->category_parent = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->category_name = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->category_icon = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->resetModified();
			...
			return $startcol + 4; // 4 = ProcessCategoryPeer::NUM_HYDRATE_COLUMNS.
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ProcessCategoryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = ProcessCategoryQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ProcessCategoryPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	{
		if (isset($alreadyDumpedObjects['ProcessCategory'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['ProcessCategory'][$this->getPrimaryKey()] = true;
	...
	{
		return null === $this->getCategoryUid();
	}
	...
	{
		$copyObj->setCategoryUid($this->getCategoryUid());
	...
	{
		return (string) $this->exportTo(ProcessCategoryPeer::DEFAULT_STRING_FORMAT);
	}
