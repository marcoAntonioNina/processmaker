...
abstract class BaseSubProcess extends BaseObject  implements Persistent
{
	...
	public function applyDefaultValues()
	{
		...
		$this->tas_parent = '';
		$this->sp_type = '';
		$this->sp_synchronous = 0;
		$this->sp_synchronous_type = '';
		$this->sp_synchronous_wait = 0;
		$this->sp_grid_in = '';
	}

	/**
	 * Initializes internal state of BaseSubProcess object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     SubProcess The current object (for fluent API support)
	 */
	...
	public function hasOnlyDefaultValues()
	{
			...
			if ($this->sp_synchronous !== 0) {
				return false;
			}

			if ($this->sp_synchronous_type !== '') {
				return false;
			}

			if ($this->sp_synchronous_wait !== 0) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->sp_uid = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			$this->pro_uid = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->tas_uid = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->pro_parent = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->tas_parent = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->sp_type = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->sp_synchronous = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			$this->sp_synchronous_type = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->sp_synchronous_wait = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
			$this->sp_variables_out = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			$this->sp_variables_in = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->sp_grid_in = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->resetModified();
			...
			return $startcol + 12; // 12 = SubProcessPeer::NUM_HYDRATE_COLUMNS.
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = SubProcessPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = SubProcessQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				SubProcessPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	{
		if (isset($alreadyDumpedObjects['SubProcess'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['SubProcess'][$this->getPrimaryKey()] = true;
	...
	{
		$copyObj->setSpUid($this->getSpUid());
		$copyObj->setProUid($this->getProUid());
		$copyObj->setTasUid($this->getTasUid());
		$copyObj->setProParent($this->getProParent());
		$copyObj->setTasParent($this->getTasParent());
		$copyObj->setSpType($this->getSpType());
		$copyObj->setSpSynchronous($this->getSpSynchronous());
		$copyObj->setSpSynchronousType($this->getSpSynchronousType());
		$copyObj->setSpSynchronousWait($this->getSpSynchronousWait());
		$copyObj->setSpVariablesOut($this->getSpVariablesOut());
		$copyObj->setSpVariablesIn($this->getSpVariablesIn());
		$copyObj->setSpGridIn($this->getSpGridIn());
		if ($makeNew) {
			$copyObj->setNew(true);
		}
	}
	...
	public function clear()
	{
		...
		$this->tas_parent = null;
		$this->sp_type = null;
		$this->sp_synchronous = null;
		$this->sp_synchronous_type = null;
		$this->sp_synchronous_wait = null;
		$this->sp_variables_out = null;
		$this->sp_variables_in = null;
		$this->sp_grid_in = null;
		$this->alreadyInSave = false;
		$this->alreadyInValidation = false;
	...
	{
		return (string) $this->exportTo(SubProcessPeer::DEFAULT_STRING_FORMAT);
	}
