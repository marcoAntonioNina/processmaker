...
abstract class BaseIsoSubdivision extends BaseObject  implements Persistent
{
	...
	/**
	 * Initializes internal state of BaseIsoSubdivision object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     IsoSubdivision The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->is_uid = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->is_name = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->resetModified();
			...
			return $startcol + 3; // 3 = IsoSubdivisionPeer::NUM_HYDRATE_COLUMNS.
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = IsoSubdivisionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = IsoSubdivisionQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				IsoSubdivisionPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	{
		if (isset($alreadyDumpedObjects['IsoSubdivision'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['IsoSubdivision'][serialize($this->getPrimaryKey())] = true;
	...
	{
		return (null === $this->getIcUid()) && (null === $this->getIsUid());
	}
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		$copyObj->setIsName($this->getIsName());
		if ($makeNew) {
			$copyObj->setNew(true);
		}
	}
	...
	{
		return (string) $this->exportTo(IsoSubdivisionPeer::DEFAULT_STRING_FORMAT);
	}
