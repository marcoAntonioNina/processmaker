...
class StepTableMap extends TableMap
{
	 ...
	 */
	const CLASS_NAME = 'classes.model.map.StepTableMap';
	...
	public function initialize()
	{
		...
		$this->addColumn('STEP_CONDITION', 'StepCondition', 'LONGVARCHAR', true, null, null);
		$this->addColumn('STEP_POSITION', 'StepPosition', 'INTEGER', true, null, 0);
		$this->addColumn('STEP_MODE', 'StepMode', 'VARCHAR', false, 10, 'EDIT');
		// validators
		$this->addValidator('STEP_TYPE_OBJ', 'validValues', 'propel.validator.ValidValuesValidator', 'DYNAFORM|INPUT_DOCUMENT|MESSAGE|OUTPUT_DOCUMENT|EXTERNAL', 'Please select a valid value for STEP_TYPE_OBJ.');
	} // initialize()
