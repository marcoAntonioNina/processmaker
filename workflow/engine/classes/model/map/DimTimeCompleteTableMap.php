...
/**
 * This class defines the structure of the 'DIM_TIME_COMPLETE' table.
 *
 *
 *
 ...
 */
class DimTimeCompleteTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'classes.model.map.DimTimeCompleteTableMap';
	...
	{
		// attributes
		$this->setName('DIM_TIME_COMPLETE');
		$this->setPhpName('DimTimeComplete');
		$this->setClassname('DimTimeComplete');
