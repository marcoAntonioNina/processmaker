...
abstract class BaseRbacUsersPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of RbacUsers objects.
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(RbacUsersPeer::TABLE_NAME);
		...
		if ($con === null) {
			$con = Propel::getConnection(RbacUsersPeer::DATABASE_NAME, Propel::CONNECTION_READ);
		}
	...
	{
		return RbacUsersPeer::populateObjects(RbacUsersPeer::doSelectStmt($criteria, $con));
	}
	/**
	 ...
	 *
	 * @param      RbacUsers $value A RbacUsers object.
	 ...
	 *
	 * @param      mixed $value A RbacUsers object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof RbacUsers) {
				$key = (string) $value->getUsrUid();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or RbacUsers object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     RbacUsers Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = RbacUsersPeer::getOMClass(false);
		// populate the object(s)
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = RbacUsersPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = RbacUsersPeer::getInstanceFromPool($key))) {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				RbacUsersPeer::addInstanceToPool($obj, $key);
			} // if key exists
		}
		$stmt->closeCursor();
		return $results;
	 ...
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 * @return     array (RbacUsers object, last column rank)
	 */
	public static function populateObject($row, $startcol = 0)
	{
		$key = RbacUsersPeer::getPrimaryKeyHashFromRow($row, $startcol);
		if (null !== ($obj = RbacUsersPeer::getInstanceFromPool($key))) {
			// We no longer rehydrate the object, since this can cause data loss.
			// See http://www.propelorm.org/ticket/509
			// $obj->hydrate($row, $startcol, true); // rehydrate
			$col = $startcol + RbacUsersPeer::NUM_HYDRATE_COLUMNS;
		} else {
			$cls = RbacUsersPeer::OM_CLASS;
			$obj = new $cls();
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseRbacUsersPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseRbacUsersPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new RbacUsersTableMap());
	  }
	}
	...
	{
		return $withPrefix ? RbacUsersPeer::CLASS_DEFAULT : RbacUsersPeer::OM_CLASS;
	}

	/**
	 * Performs an INSERT on the database, given a RbacUsers or Criteria object.
	 *
	...
	{
		if ($con === null) {
			$con = Propel::getConnection(RbacUsersPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}
	...
	/**
	 * Performs an UPDATE on the database, given a RbacUsers or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(RbacUsersPeer::USR_UID);
			if ($value) {
				$selectCriteria->add(RbacUsersPeer::USR_UID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(RbacUsersPeer::TABLE_NAME);
			}
	...
	public static function doDeleteAll(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(RbacUsersPeer::TABLE_NAME, $con, RbacUsersPeer::DATABASE_NAME);
			// Because this db requires some delete cascade/set null emulation, we have to
			// clear the cached instance *after* the emulation has happened (since
			// instances get re-added by the select statement contained therein).
			RbacUsersPeer::clearInstancePool();
			RbacUsersPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Performs a DELETE on the database, given a RbacUsers or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
		...
		} elseif ($values instanceof RbacUsers) { // it's a model object
			// invalidate the cache for this single object
			RbacUsersPeer::removeInstanceFromPool($values);
			...
			foreach ((array) $values as $singleval) {
				RbacUsersPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = RbacUsersPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
...
//
BaseRbacUsersPeer::buildTableMap();
