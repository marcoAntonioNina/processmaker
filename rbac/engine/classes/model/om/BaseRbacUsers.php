...
abstract class BaseRbacUsers extends BaseObject  implements Persistent
{
	...
	/**
	 * Initializes internal state of BaseRbacUsers object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     RbacUsers The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 14; // 14 = RbacUsersPeer::NUM_HYDRATE_COLUMNS.
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = RbacUsersPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = RbacUsersQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				RbacUsersPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	{
		if (isset($alreadyDumpedObjects['RbacUsers'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['RbacUsers'][$this->getPrimaryKey()] = true;
	...
	{
		return (string) $this->exportTo(RbacUsersPeer::DEFAULT_STRING_FORMAT);
	}
