...
require_once 'classes/model/map/".$this->getTablePhpName()."TableMap.php';

include_once 'classes/model/". $this->getTablePhpName() .".php';";
    } // addIncludes()
...
";
        ...
        $script .= "
            ...
            // \$values is ".$this->getObjectClassname()." object
