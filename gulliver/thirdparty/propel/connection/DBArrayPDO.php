...
class DBArrayPDO extends PDO
{
    ...
    protected static $defaultLogMethods = array(
        'DBArrayPDO::exec',
        'DBArrayPDO::query',
        'DBArrayPDOStatement::execute',
    );

    /**
     * Creates a DBArrayPDO instance representing a connection to a database.
     *.
     ...
     * Add DBArrayPDO::__construct to $defaultLogMethods to see this message
     *
    ...
    public function __construct($dsn, $username = null, $password = null, $driver_options = array())
    {
        ...
        if ($this->useDebug) {
            $this->configureStatementClass('DBArrayPDOStatement', true);
    ...
    */
     ...
     *
     * @param     integer  $attribute  The attribute to set (e.g. DBArrayPDO::PROPEL_ATTR_CACHE_PREPARES).
     ...
     * This is overridden here to provide support for setting Propel-specific attributes too.
     *
     * @param     integer  $attribute  The attribute to get (e.g. DBArrayPDO::PROPEL_ATTR_CACHE_PREPARES).
     * @return    mixed
     */
     ...
     *  - Add query caching support if the DBArrayPDO::PROPEL_ATTR_CACHE_PREPARES was set to true.
     *
     ...
     *
     * When using DBArrayPDOStatement as the statement class, any queries by DBArrayPDOStatement instances
     * are counted as well.
     *
    ...
    public function getQueryCount()
    {
        ...
        if ($this->getAttribute(PDO::ATTR_PERSISTENT)) {
            throw new PropelException('Extending PDOStatement is not supported with persistent connections. Count would be inaccurate, because we cannot count the PDOStatment::execute() calls. Either don\'t use persistent connections or don\'t call DBArrayPDO::getQueryCount()');
        }
     ...
     * Add DBArrayPDO::__destruct to $defaultLogMethods to see this message
     *
     * @see       self::log()
     */
...
class DBArrayPDOStatement extends PDOStatement
{
    /**
